...
#define CantMaxLinAd 3           //Numero maximo de Lineas adicionales con el Cliente
...
const char NameFileComprobareMMC[] = "/comp_eMMC.json";       //Archivo para Comprobar Cambios en la eMMC
...
const char CMD_Encabezado[] = "enc";          //Comando Encabezado
const char CMD_Cliente[] = "cli";             //Comando Cliente
const char CMD_Comentario[] = "com";          //Comando Comentario
const char CMD_Producto[] = "pro";            //Comando Productos/Articulos
const char CMD_DescPorc[] = "desP";            //Comando Descuento por Porcentaje (Ultimo Producto)
const char CMD_DescMont[] = "desM";            //Comando Descuento por Monto (Ultimo Producto)
const char CMD_RecPorc[] = "recP";            //Comando Recargo por Porcentaje (Ultimo Producto)
const char CMD_RecMont[] = "recM";            //Comando Recargo por Monto (Ultimo Producto)
const char CMD_CorrPro[] = "corP";            //Comando de Correccion de Producto, No tiene Agumentos (Elimina el monto del Producto)
const char CMD_AnulaPro[] = "anuP";            //Comando de Anulacion de Producto, Argumentos (Descripcion1, Precio, Cantidad), Busca el Producto y lo Anula
const char CMD_setTimer[] = "setTime";              //Comando Time
const char CMD_GetTime[] = "getTime";
const char CMD_FormPago[] = "fpa";            //Comando Forma de Pago
const char CMD_EndProducto[] = "endP";        //Comando Fin de Producto
const char CMD_LineAdicionales[] = "linA";        //Comando de Lineas adicionales despues de fin de Producto
const char CMD_PieTicket[] = "pieT";          //Comando Pie de Ticket. despues de Lineas Adicionales
